...
SHAPEFILES = {
    ...
    'Los Angeles County Sheriff Field Operations Regions': {
        'file': 'la-county-sheriff/field-operations-regions.shp',
        'singular': 'Los Angeles County Sheriff Field Operations Region',
        'kind_first': False,
        'ider': utils.simple_namer(['number']),
        'namer': utils.simple_namer(['name']),
        'authority': 'Los Angeles County Sheriff',
    ...
    'Los Angeles County Sheriff Station Areas': {
        'file': 'la-county-sheriff/station-areas.shp',
        'singular': 'Los Angeles County Sheriff Station Area',
        'kind_first': False,
    ...
    'Los Angeles County Sheriff Reporting Districts': {
        'file': 'la-county-sheriff/reporting-districts.shp',
        'singular': 'Los Angeles County Sheriff Reporting District',
        'kind_first': False,
        'ider': utils.simple_namer(['name']),
        'namer': utils.simple_namer(['name']),
        'authority': 'Los Angeles County Sheriff',
    ...
    'Los Angeles County Board of Supervisors Districts (1971)': {
        'file': 'la-county-supervisors/1971/districts.shp',
        'singular': 'Los Angeles County Board of Supervisors District (1971)',
        'kind_first': False,
        ...
        'notes': 'Political districts for Los Angeles County Board of Supervisors',
        'encoding': '',
        'srid': '4326',
        'simplification': 0.0001,
    },
    'Los Angeles County Board of Supervisors Districts (1981)': {
        'file': 'la-county-supervisors/1981/districts.shp',
        'singular': 'Los Angeles County Board of Supervisors District (1981)',
        'kind_first': False,
        'ider': utils.simple_namer(['DISTRICT']),
        'namer': utils.simple_namer(['DISTRICT']),
        'authority': 'Los Angeles County GIS Data Portal',
    ...
    'Los Angeles County Board of Supervisors Districts (1991)': {
        'file': 'la-county-supervisors/1991/districts.shp',
        'singular': 'Los Angeles County Board of Supervisors District (1991)',
        'kind_first': False,
        'ider': utils.simple_namer(['DISTRICT']),
        'namer': utils.simple_namer(['DISTRICT']),
        'authority': 'Los Angeles County GIS Data Portal',
    ...
    'Los Angeles County Board of Supervisors Districts (2001)': {
        'file': 'la-county-supervisors/2001/2001.shp',
        'singular': 'Los Angeles County Board of Supervisors District (2001)',
        'kind_first': False,
        'ider': utils.simple_namer(['SUP_DIST']),
        'namer': utils.simple_namer(['SUP_DIST']),
        'authority': 'Los AngelesCounty GIS Data Portal',
        'domain': 'Los Angeles County',
    ...
    'Los Angeles County Board of Supervisors Districts (2011)': {
        'file': 'la-county-supervisors/2011/districts.shp',
        'singular': 'Los Angeles County Board of Supervisors District (2011)',
        'kind_first': False,
        'ider': utils.simple_namer(['DISTRICT']),
        'namer': utils.simple_namer(['DISTRICT']),
        'authority': 'Los Angeles County GIS Data Portal',
    ...
    'Los Angeles County Fire Department Station Areas': {
        'file': 'la-county-fd/station-areas.shp',
        'singular': 'Los Angeles County Fire Department Station Area',
        'kind_first': True,

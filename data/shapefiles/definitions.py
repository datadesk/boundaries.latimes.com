...
SHAPEFILES = {
    'Unified School Districts (2012)': {
        'file': 'census-2012/unified-school-districts.shp',
        'singular': 'Unified School District (2012)',
        'kind_first': False,
    ...
    'L.A. County Sheriff Field Operations Regions': {
        ...
        'href': '',
        'notes': 'Administrative districts of the L.A. County Sheriff\'s Department',
        'encoding': '',
        'srid': '4326',
        'simplification': 0.0001,
    },
    ...
    'LAPD Divisions': {
        ...
        'ider': utils.simple_namer(['number']),
        'namer': utils.simple_namer(['name']),
        'authority': 'L.A. Police Department',
        'domain': 'L.A. city',
        'last_updated': date(2011, 12, 23),
        'href': '',
        'notes': 'Administrative districts of the Los Angeles Police Department',
...
#    },
    ...
    'L.A. County Fire Department Station Areas': {
        'file': 'la-county-fd/station-areas.shp',
        'singular': 'L.A. County Fire Department Station Area',
        'kind_first': True,
        'ider': utils.simple_namer(['STATID']),
        'namer': utils.simple_namer(['STATID']),
        'authority': 'L.A. County Fire Department',
        'domain': 'L.A. County',
        'last_updated': date(2011, 3, 1),
        'href': '',
        'notes': 'The administrative organization of the L.A. County Fire Department',
        'encoding': '',
        'srid': '4326',
        'simplification': 0.0001,
    },
    'LAFD First-in Districts': {
        ...
        'authority': 'L.A. Fire Department',
        'domain': 'L.A. City',
        'last_updated': date(2009, 1, 27),
        'href': '',
        'notes': 'The lowest level of administrative organization in the L.A. Fire Department',
        'encoding': '',
        'srid': '4326',
        'simplification': 0.0001,
    },
    ...
    'L.A. County Regions (V3)': {
        'file': 'neighborhoods/v3/regions.shp',
        'singular': 'L.A. County Region (V3)',
        'kind_first': False,
        'ider': utils.simple_namer(['slug']),
        'namer': utils.simple_namer(['name']),
        'authority': 'Los Angeles Times',
        'domain': 'L.A. County',
        'last_updated': date(2010, 3, 8),
        'href': 'http://maps.latimes.com/about/',
        'notes': 'The third version of L.A. County regions as defined by the Los Angeles Times',
        'encoding': '',
        'srid': '4326',
        'simplification': 0.0001,
    },
    'L.A. County Regions (V5)': {
        ...
        'notes': 'The fifth version of L.A. County regions as defined by the Los Angeles Times',
        'encoding': '',
        'srid': '4326',
        'simplification': 0.0001,
    },
    'L.A. County Regions (V6)': {
        'file': 'neighborhoods/v6/regions.shp',
        'singular': 'L.A. County Region (V6)',
        'kind_first': False,
        'ider': utils.simple_namer(['slug']),
        'namer': utils.simple_namer(['name']),
        'authority': 'Los Angeles Times',
        'domain': 'L.A. County',
        'last_updated': date(2013, 9, 25),
        'href': 'http://projects.latimes.com/mapping-la/about/',
        'notes': 'TThe sixth version of regions defined by the Los Angeles Times. Covers Los Angeles and Orange counties.',
        'encoding': '',
        'srid': '4326',
        'simplification': 0.0001,
    },
    'L.A. County Regions (Current)': {
        ...
        'last_updated': date(2013, 9, 25),
        'href': 'http://maps.latimes.com/about/',
        'notes': 'The current version of regions as defined by the Los Angeles Times. Covers Los Angeles and Orange counties.',
        'encoding': '',
        'srid': '4326',
        'simplification': 0.0001,
    },
    'L.A. County Municipal Regions (V5)': {
        ...
        'last_updated': date(2010, 5, 24),
        'href': 'http://maps.latimes.com/about/',
        'notes': 'The fifth version of L.A. County municipal regions as defined by the Los Angeles Times',
        'encoding': '',
        'srid': '4326',
        'simplification': 0.0001,
    },
    'L.A. County Municipal Regions (V6)': {
        'file': 'neighborhoods/v6/municipal_regions.shp',
        'singular': 'L.A. County Municipal Region (V6)',
        'kind_first': False,
        'ider': utils.simple_namer(['slug']),
        'namer': utils.simple_namer(['name']),
        'authority': 'Los Angles Times',
        'domain': 'L.A. County',
        'last_updated': date(2013, 9, 30),
        'href': 'http://maps.latimes.com/about/',
        'notes': 'The sixth version of L.A. County municipal regions as defined by the Los Angeles Times',
        'encoding': '',
        'srid': '4326',
        'simplification': 0.0001,
    },
    'L.A. County Municipal Regions (Current)': {
        ...
        'last_updated': date(2010, 5, 24),
        'href': 'http://maps.latimes.com/about/',
        'notes': 'The current version of L.A. County municipal regions as defined by the Los Angeles Times',
        'encoding': '',
        'srid': '4326',
        'simplification': 0.0001,
    },
    'L.A. County Neighborhoods (V1)': {
        'file': 'neighborhoods/v1/neighborhoods.shp',
        'singular': 'L.A. County Neighborhood (V1)',
        'kind_first': False,
        'ider': utils.simple_namer(['slug']),
        'namer': utils.simple_namer(['name']),
        'authority': 'Los Angles Times',
        'domain': 'L.A. County',
        'last_updated': date(2009, 2, 17),
        'href': 'http://maps.latimes.com/about/',
        'notes': 'The first version of L.A. County neighborhoods as defined by the Los Angeles Times',
        'encoding': '',
        'srid': '4326',
        'simplification': 0.0001,
    },
    'L.A. County Neighborhoods (V2)': {
        'file': 'neighborhoods/v2/neighborhoods.shp',
        'singular': 'L.A. County Neighborhood (V2)',
        'kind_first': False,
        'ider': utils.simple_namer(['slug']),
        'namer': utils.simple_namer(['name']),
        'authority': 'Los Angles Times',
        ...
        'last_updated': date(2010, 3, 8),
        'href': 'http://maps.latimes.com/about/',
        'notes': 'The second version of L.A. County neighborhoods as defined by the Los Angeles Times',
        'encoding': '',
        'srid': '4326',
        'simplification': 0.0001,
    },
    'L.A. County Neighborhoods (V3)': {
        'file': 'neighborhoods/v3/neighborhoods.shp',
        'singular': 'L.A. County Neighborhood (V3)',
        'kind_first': False,
        'ider': utils.simple_namer(['slug']),
        'namer': utils.simple_namer(['name']),
        'authority': 'Los Angles Times',
        ...
        'last_updated': date(2010, 3, 8),
        'href': 'http://maps.latimes.com/about/',
        'notes': 'The third version of L.A. County neighborhoods as defined by the Los Angeles Times',
        'encoding': '',
        'srid': '4326',
        'simplification': 0.0001,
    },
    'L.A. County Neighborhoods (V4)': {
        'file': 'neighborhoods/v4/neighborhoods.shp',
        'singular': 'L.A. County Neighborhood (V4)',
        'kind_first': False,
        'ider': utils.simple_namer(['slug']),
        'namer': utils.simple_namer(['name']),
        'authority': 'Los Angles Times',
        'domain': 'L.A. County',
        'last_updated': date(2010, 3, 22),
        'href': 'http://maps.latimes.com/about/',
        'notes': 'The fourth version of L.A. County neighborhoods as defined by the Los Angeles Times',
        'encoding': '',
        'srid': '4326',
        'simplification': 0.0001,
    },
    'L.A. County Neighborhoods (V5)': {
        ...
        'last_updated': date(2010, 5, 24),
        'href': 'http://maps.latimes.com/about/',
        'notes': 'The fifth version of L.A. County neighborhoods as defined by the Los Angeles Times',
        'encoding': '',
        'srid': '4326',
        'simplification': 0.0001,
    },
    'L.A. County Neighborhoods (V6)': {
        'file': 'neighborhoods/v6/neighborhoods.shp',
        'singular': 'L.A. County Neighborhood (V6)',
        'kind_first': False,
        'ider': utils.simple_namer(['slug']),
        'namer': utils.simple_namer(['name']),
        'authority': 'Los Angles Times',
        'domain': 'L.A. and Orange counties',
        'last_updated': date(2013, 9, 25),
        'href': 'http://maps.latimes.com/about/',
        'notes': 'The sixth version of neighborhoods defined by the Los Angeles Times. Covers Los Angeles and Orange counties.',
        'encoding': '',
        'srid': '4326',
        'simplification': 0.0001,
    },
    'L.A. County Neighborhoods (Current)': {
        ...
        'last_updated': date(2013, 9, 25),
        'href': 'http://maps.latimes.com/about/',
        'notes': 'The current version of neighborhoods as defined by the Los Angeles Times. Covers Los Angeles and Orange counties.',
        'encoding': '',
        'srid': '4326',
        'simplification': 0.0001,
    },
    ...
    'L.A. City Council Districts (2012)': {
        ...
        'ider': utils.simple_namer(['District'], normalizer=int),
        'namer': utils.simple_namer(['District'], normalizer=int),
        'authority': 'L.A. City Council Redistricting Commission',
        'domain': 'L.A. city',
